...
export default function ZarrViewer() {
  const { hasLoadedArray, msInfo, omeData, isLoading, store } = useZarrStore()
  ...
  return (
    <div className="w-full h-full flex relative overflow-hidden">
      {/* Sidebar Controls (Contains File Explorer) - Always show */}
        ...
        <div className="flex-1 flex items-center justify-center p-5 text-center text-gray-500 italic">
          {isLoading
            ...
            : store
              ...
              : "Enter a server URL in the sidebar to begin"}
        </div>
      )}
    </div>
  )
